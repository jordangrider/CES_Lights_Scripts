...
def send_and_receive(ser):
    if ser is not None:
        try:
            ...
            ser.write(b"51,10,1,2000,1,20,255,255,0 \n")
            ser.write(b"51,10,1,4000,1,20,0,0,0 \n")
            ser.write(b"51,10,2,4000,1,20,0,255,0 \n")
            ser.write(b"51,10,2,6000,1,20,0,0,0 \n")
            ser.write(b"51,10,3,6000,1,20,0,255,255 \n")
            ser.write(b"51,10,3,8000,1,20,0,0,0 \n")
            ser.write(b"51,10,4,8000,1,20,0,0,255 \n")
            ser.write(b"51,10,4,10000,1,20,0,0,0 \n")
